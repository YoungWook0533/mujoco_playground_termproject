...
from mujoco_playground._src.manipulation.franka_emika_panda import open_door as panda_open_door
...
from mujoco_playground._src.manipulation.husky_fr3 import open_cabinet as husky_fr3_open_cabinet
from mujoco_playground._src.manipulation.husky_fr3 import open_door as husky_fr3_open_door
...
_envs = {
    ...
    "PandaOpenDoor": panda_open_door.PandaOpenDoor,
    "PandaRobotiqPushCube": robotiq_push_cube.PandaRobotiqPushCube,
    "HuskyFR3OpenCabinet": husky_fr3_open_cabinet.HuskyFR3OpenCabinet,
    "HuskyFR3OpenDoor": husky_fr3_open_door.HuskyFR3OpenDoor,
...
_cfgs = {
    ...
    "PandaOpenDoor": panda_open_door.default_config,
    "PandaRobotiqPushCube": robotiq_push_cube.default_config,
    "HuskyFR3OpenCabinet": husky_fr3_open_cabinet.default_config,
    "HuskyFR3OpenDoor": husky_fr3_open_door.default_config,
